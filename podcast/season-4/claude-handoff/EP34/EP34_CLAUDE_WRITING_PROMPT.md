...
# Claude Writing Prompt — EP34: Reliability Validation and Production Reality

Write the complete final two-character spoken dialogue for **EP34 — Reliability Validation and Production Reality**, Season 4.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-4/claude-handoff/EP34/EP34_HANDOFF_MANIFEST.md
...
## Output format
# EP34 — Reliability Validation and Production Reality
