...
## Task
Write the complete two-character dialogue for **EP52 — Manufacturing Data Engineers Can Actually Use**, Season 5.

This is not a research task. Do not redesign the episode, broaden the scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP52/EP52_HANDOFF_MANIFEST.md
