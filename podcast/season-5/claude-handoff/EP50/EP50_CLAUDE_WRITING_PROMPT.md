...
# Claude Writing Prompt — EP50: The Manufacturing Atlas: Turning Knowledge into Decisions

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP50 — The Manufacturing Atlas: Turning Knowledge into Decisions**, Season 5.

This is not a research task. Do not redesign the episode, broaden the scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP50/EP50_HANDOFF_MANIFEST.md
