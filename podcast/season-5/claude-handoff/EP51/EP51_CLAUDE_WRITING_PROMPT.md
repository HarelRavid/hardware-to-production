...
# Claude Writing Prompt — EP51: OPC UA, ISA-95 and Semantic Integration Without the Buzzwords

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP51 — OPC UA, ISA-95 and Semantic Integration Without the Buzzwords**, Season 5.

This is not a research task. Do not redesign the episode, broaden the scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP51/EP51_HANDOFF_MANIFEST.md
