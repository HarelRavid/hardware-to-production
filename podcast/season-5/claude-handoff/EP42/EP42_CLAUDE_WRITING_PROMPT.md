...
# Claude Writing Prompt — EP42: Building the Business Case for Automation

Write the complete final two-character spoken dialogue for **EP42 — Building the Business Case for Automation**, Season 5.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP42/EP42_HANDOFF_MANIFEST.md
