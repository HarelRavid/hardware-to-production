...
# Claude Writing Prompt — EP43: Semi-Automation, Robotics and Machine Vision

Write the complete final two-character spoken dialogue for **EP43 — Semi-Automation, Robotics and Machine Vision**, Season 5.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP43/EP43_HANDOFF_MANIFEST.md
...
Owns the engineering decision, mechanism, evidence boundary and canonical tool.

**RONA — Practitioner / Challenger**
Technically competent. Pushes on automation hype, economics, maintainability, operators, abnormal states and whether the intervention actually improves accepted output.

## Requirements
- Open with the approved hook.
- Follow the outline.
- Execute the primary listener tool on the worked example.
- Keep automation subordinate to process maturity/evidence.
- Use concise callbacks.
- End with one practical action and correct handoff.

## Technical truth rules
- Use only locked claims.
- Do not invent safety rules, OEE benchmarks, capability targets, machine rates, economic values or legal requirements.
- Do not strengthen guidance into requirement.
...
## Self-check
No unsupported claim, number, standards requirement, automation hype, duplicated episode ownership or invented case.
