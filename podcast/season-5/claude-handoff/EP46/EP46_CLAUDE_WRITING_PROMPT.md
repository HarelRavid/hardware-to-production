...
# Claude Writing Prompt — EP46: Scaling Without Automating Defects

Write the complete final two-character spoken dialogue for **EP46 — Scaling Without Automating Defects**, Season 5.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-5/claude-handoff/EP46/EP46_HANDOFF_MANIFEST.md
