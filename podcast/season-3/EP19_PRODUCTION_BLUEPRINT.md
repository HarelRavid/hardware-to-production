...
## Season closing
The listener now knows how to choose and connect manufacturing processes. Season 4 can therefore move from “how should the part be made?” to “how do we build the production system that executes those routes repeatedly?”
