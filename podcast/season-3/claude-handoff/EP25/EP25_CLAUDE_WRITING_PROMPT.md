...
# Claude Writing Prompt — EP25: Layout, Material Flow and Ergonomics

Write the complete final two-character spoken dialogue for **EP25 — Layout, Material Flow and Ergonomics**, Season 3 of Hardware-to-Production.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-3/claude-handoff/EP25/EP25_HANDOFF_MANIFEST.md
...
## Output
# EP25 — Layout, Material Flow and Ergonomics
