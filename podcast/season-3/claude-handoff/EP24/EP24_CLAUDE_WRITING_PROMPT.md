...
# Claude Writing Prompt — EP24: Production Testing and Measurement-System Capability

Write the complete final two-character spoken dialogue for **EP24 — Production Testing and Measurement-System Capability**, Season 3 of Hardware-to-Production.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-3/claude-handoff/EP24/EP24_HANDOFF_MANIFEST.md
...
## Authority order
Claim Lock → Source Register → Technical Review → Script Outline → Blueprint → Season Continuity/Backbone → Supporting files → Existing Full Script Draft as reference only.
