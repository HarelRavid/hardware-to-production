...
# Claude Writing Prompt — EP22: Work Instructions, Standard Work and Operator Qualification

Write the complete final two-character spoken dialogue for **EP22 — Work Instructions, Standard Work and Operator Qualification**, Season 3 of Hardware-to-Production.

This is a writing task, not a research task.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-3/claude-handoff/EP22/EP22_HANDOFF_MANIFEST.md
...
## Output
# EP22 — Work Instructions, Standard Work and Operator Qualification
