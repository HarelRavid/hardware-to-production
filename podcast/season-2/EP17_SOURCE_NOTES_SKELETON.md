...
- NIST AM Standards.
- Wave 06A / Wave 03 AM economics context.

## Source-use boundary
Use standards and NIST sources for:
- terminology;
- qualification layers;
- measurement/inspection challenges;
- process/post-process evidence.

Do not infer:
- universal property values;
- universal break-even volumes;
- one qualification method;
- one AM process hierarchy.

## Internal synthesis
- AM Value Test;
- Production-AM Evidence Checklist;
- “printable ≠ production viable” framing;
- final accepted-part economics comparison.
