...
## Closing handoff
Season 2 ends with a product designed not only to function, but to be manufactured, assembled, tested, specified and supported as a population over time. Season 3 asks the next practical question: which manufacturing processes should actually create the parts and assemblies?
