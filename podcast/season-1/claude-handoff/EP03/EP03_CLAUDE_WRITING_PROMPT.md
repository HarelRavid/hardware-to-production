...
# Claude Writing Prompt — EP03: What NPI and Industrialization Actually Own

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP03 — What NPI and Industrialization Actually Own**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP03/EP03_HANDOFF_MANIFEST.md
...
## Output format
# EP03 — What NPI and Industrialization Actually Own
