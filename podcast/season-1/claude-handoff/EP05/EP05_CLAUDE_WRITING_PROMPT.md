...
# Claude Writing Prompt — EP05: EVT, DVT, PVT, Pilot and Ramp Without the Buzzwords

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP05 — EVT, DVT, PVT, Pilot and Ramp Without the Buzzwords**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP05/EP05_HANDOFF_MANIFEST.md
...
## Output format
# EP05 — EVT, DVT, PVT, Pilot and Ramp Without the Buzzwords
