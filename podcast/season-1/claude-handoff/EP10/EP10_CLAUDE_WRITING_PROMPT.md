...
# Claude Writing Prompt — EP10: Designing for Reliability, Service and Repair

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP10 — Designing for Reliability, Service and Repair**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP10/EP10_HANDOFF_MANIFEST.md
...
## Output format
# EP10 — Designing for Reliability, Service and Repair
