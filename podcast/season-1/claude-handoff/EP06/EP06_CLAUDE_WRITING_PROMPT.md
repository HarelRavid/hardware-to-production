...
# Claude Writing Prompt — EP06: Design for Manufacturing: Designing for a Process, Not a CAD Model

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP06 — Design for Manufacturing: Designing for a Process, Not a CAD Model**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP06/EP06_HANDOFF_MANIFEST.md
...
## Output format
# EP06 — Design for Manufacturing: Designing for a Process, Not a CAD Model
