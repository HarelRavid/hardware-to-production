...
# Claude Writing Prompt — EP07: Design for Assembly and Mistake Prevention

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP07 — Design for Assembly and Mistake Prevention**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP07/EP07_HANDOFF_MANIFEST.md
...
## Output format
# EP07 — Design for Assembly and Mistake Prevention
