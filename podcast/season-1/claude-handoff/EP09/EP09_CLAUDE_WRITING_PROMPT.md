...
# Claude Writing Prompt — EP09: Tolerance, GD&T/GPS and Variation

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP09 — Tolerance, GD&T/GPS and Variation**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP09/EP09_HANDOFF_MANIFEST.md
...
## Output format
# EP09 — Tolerance, GD&T/GPS and Variation
