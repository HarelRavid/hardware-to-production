...
# Claude Writing Prompt — EP04: Product Readiness vs Manufacturing Readiness

You are writing the final spoken dialogue for the Hardware-to-Production podcast.

## Task
Write the complete two-character dialogue for **EP04 — Product Readiness vs Manufacturing Readiness**, Season 1.

This is not a research task. Do not redesign the episode, broaden scope, or invent engineering guidance.

## Read first
Handoff Manifest:
https://github.com/HarelRavid/hardware-to-production/blob/main/podcast/season-1/claude-handoff/EP04/EP04_HANDOFF_MANIFEST.md
...
## Output format
# EP04 — Product Readiness vs Manufacturing Readiness
