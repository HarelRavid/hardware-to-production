---
id: H2P-PW-185
title: Polymer AM Post-processing
object_type: Process
...
Formlabs current SLA guidance explicitly treats washing and post-curing as required workflow steps for engineering resins. SLS workflows require powder recovery/depowdering and typically media blasting. Commercial SLS data also shows powder refresh rate as a material/process-economic parameter.
...
| INCLUDES | H2P-PW-183 SLA Post-Cure State | Strong | High | SLA cure is a critical post-process | Formlabs TDS |
